...
export async function POST(request: Request) {
  ...
  try {
    // Rate limit by IP
    const ipRateLimitResponse = await rateLimit(request as NextRequest, rateLimits.resendVerification)
    ...
    const emailRateLimitResponse = await rateLimit(request as NextRequest, {
